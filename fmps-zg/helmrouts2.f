...
c                 (calls FORMMPONEH3D/FORMMPH3D0 for each source)
c
...
c      H3DALL    : computes Hankel functions of all orders and scales
c                  them
c
...
c                 a collection of sources.
c                 (calls FORMTAH3DONE/FORMTAH3D0 for each source)
c
...
c                 (calls FORMMPONEH3D_DP/FORMMPH3D0_DP for each source)
c
