...
c
C*****************************************************************
        subroutine rotviarecur2(nterms,m1,m2,mpole,ld1,marray,
...
c       the two term recurrence, rathen than storing them for all orders
...
c
	...
	hsthta=ww*stheta
	cthtap=ww*(done+ctheta)
	cthtan=-ww*(done-ctheta)
c
