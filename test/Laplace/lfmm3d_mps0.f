c
       subroutine lfmm3dmps0(nd, eps ,nmpole, cmpole, rmpole, mterms,
...
c      temp variables
       integer k,ii,jj,kk,ll,m,idim,iloc
       integer ibox,jbox,npts,npts0
       integer nchild
...
cc     memory management code for contructing level restricted tree
       call pts_tree_mem(cmpole,nmpole,targtree,ntargtree,idivflag,ndiv,
...
c       Call tree code
       call pts_tree_build(cmpole,nmpole,targtree,ntargtree,idivflag,
...
C$         ithd=omp_get_thread_num()
     ...
     5            nwall,wall(1,ithd))
             ...
             call processlist3udexplong(nd,ibox,nboxes,treecenters,
     ...
     7            xshift,yshift,zshift,fexpback,rlsc,rscpow)
             ...
             call processlist3nsexplong(nd,ibox,nboxes,treecenters,
     1            boxsize(ilev),nterms(ilev),iboxlexp(1,1,ithd),rlams,
     2            whts,nlams,nfourier,nphysical,nthmax,nexptot,
     ...
     7            xshift,yshift,zshift,fexpback,rlsc,rscpow)
             ...
             call processlist3ewexplong(nd,ibox,nboxes,treecenters,
     1            boxsize(ilev),nterms(ilev),iboxlexp(1,1,ithd),rlams,
     2            whts,nlams,nfourier,nphysical,nthmax,nexptot,
...
c---------------------------------------------------------------
c
       subroutine lfmm3dmain_mps0(nd,eps,
     ...
     $            scales,laddr,nterms,ier)
       ...
       double precision treecenters(3,nboxes)
